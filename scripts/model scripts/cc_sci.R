...
# this is the script that created the model that we have in place
...
metrics <- regular_res %>%
  collect_metrics()
write.csv(metrics, "cc_sci_southEastWImetrics.csv", row.names = FALSE, quote = FALSE)
...
saveRDS(mod, "cc_sci_southEastWI.rds")
